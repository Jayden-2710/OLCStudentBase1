...
country = input("Please enter the name of a country: ").lower()  # country = country.lower()
if country in capital_cities:
    cap = capital_cities[country]
...
if remove == 'Y':
    country_remove = input('What country would you like to remove').lower()
    del capital_cities[country_remove]
add = input("Would you like to add a new entry? (Y or N): ")
...
if add == 'Y':
    country_add=input('What country would you like to add?')
    add_capitol=input('What is the name of the capitol of the country in which you would like to add?')
    capital_cities[country_add] = add_capitol
